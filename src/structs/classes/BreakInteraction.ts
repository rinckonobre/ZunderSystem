import { ButtonInteraction, CommandInteraction, ColorResolvable, ContextMenuCommandInteraction, StringSelectMenuInteraction, ModalSubmitInteraction, Message, EmbedBuilder, GuildMember} from "discord.js";
import { config } from "../..";
